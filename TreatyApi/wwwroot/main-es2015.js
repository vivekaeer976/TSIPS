...
let ActionbydateofmodificationComponent = class ActionbydateofmodificationComponent {
    constructor(service) {
    ...
    ngOnInit() {
        ...
        //this.treatyItem.WebPublished = "False";
        //this.treaty.treatyItems.push(this.treatyItem);
        this.service.getAllTreatyItems().subscribe((response) => {
            this.treaty.treatyItems = response;
            this.treatyItems = response;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.treaty.treatyItems);
            debugger;
            //  if (response != null) {
...
ActionbydateofmodificationComponent.ctorParameters = () => [
...
let EditTreatyComponent = class EditTreatyComponent {
...
EditTreatyComponent.ctorParameters = () => [
...
let TreatyserviceService = class TreatyserviceService {
...
TreatyserviceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let TreatyModule = class TreatyModule {
};
